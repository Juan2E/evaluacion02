package com.tecsup.eva021.aop;

import com.tecsup.eva021.domain.entities.*;
import com.tecsup.eva021.domain.persistence.AuditoriaDao;
...
public class LogginAspecto {
    ...
    @Around("execution(* com.tecsup.eva021.service.*ServiceImpl.*(..))")
    ...
    @After("execution(* com.tecsup.eva021.controllers.*Controller.guardar*(..)) ||" +
            "execution(* com.tecsup.eva021.controllers.*Controller.editar*(..)) ||" +
            "execution(* com.tecsup.eva021.controllers.*Controller.eliminar*(..))")
